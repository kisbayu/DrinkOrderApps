CREATE TABLE `asc_drink_order_app`.`orders` ( 
  ...
  `menu_mineral_water_qty` INT,
  `menu_cold_sweet_tea_qty` INT,
  `menu_hot_sweet_tea_qty` INT,
  `menu_cold_black_coffee_qty` INT,
  `menu_hot_black_coffee_qty` INT,
  `menu_cold_cream_coffee_qty` INT,
  `menu_hot_cream_coffee_qty` INT,
  `menu_cold_ocha_qty` INT,
  `menu_hot_ocha_qty` INT,
